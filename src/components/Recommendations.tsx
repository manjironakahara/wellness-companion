...
const Recommendations = ({ recommendations, isGenerating, onViewCalendar, onAdjustPlan }: RecommendationsProps) => {
  return (
      ...
      <div className="relative z-10 flex-1 flex flex-col px-6 pt-10 pb-8">
        ...
        {isGenerating ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4">
            <Loader2 className="w-10 h-10 onboarding-question animate-spin" />
            <p className="text-lg onboarding-transcript text-center max-w-sm leading-relaxed">
              AI is analyzing your profile and building a personalized plan...
            </p>
          </div>
        ) : recommendations ? (
          <>
